...
| R8 | Calculate variable dependents from formulae | `model.test.js::when model contains dependents` | Dependents (inverse of dependencies) are calculated from formulae, showing which variables depend on each variable |
