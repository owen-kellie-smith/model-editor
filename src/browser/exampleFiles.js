export const exampleFiles = [
  { category: "model", path: "docs/examples/annuity-model/vendor-format-model.xml" },
  { category: "model", path: "docs/examples/rocket-model/rocket_with_thrust.xml" },
  { category: "model", path: "docs/examples/rocket-model/lorenz-difference.xml" },
